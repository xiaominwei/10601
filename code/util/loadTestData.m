...
f1=load([directory '/data_batch_1.mat']);
f2=load([directory '/data_batch_2.mat']);
f3=load([directory '/data_batch_3.mat']);
f4=load([directory '/data_batch_4.mat']);
f5=load([directory '/data_batch_5.mat']);
