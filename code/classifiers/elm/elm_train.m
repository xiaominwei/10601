function [TrainingTime,TrainingAccuracy,Model] = elm_train(trainT, trainP, Elm_Type, NumberofHiddenNeurons, ActivationFunction)
...
if Elm_Type~=REGRESSION
    Model.NumberofInputNeurons = NumberofInputNeurons;
    Model.NumberofOutputNeurons = NumberofOutputNeurons;
    ...
    save('Model.dat', 'InputWeight', 'BiasofHiddenNeurons', 'OutputWeight', 'ActivationFunction', 'Elm_Type');    
end
